...
BG = pygame.transform.scale(pygame.image.load("spacebackground.jpg"), (WIDTH, HEIGHT))
...
FONT = pygame.font.SysFont("TimeNewRoman", 30)
...
def main():
    ...
    while run:
        ...
        if hit:
            lost_text = FONT.render("You gay", 1, "green")
